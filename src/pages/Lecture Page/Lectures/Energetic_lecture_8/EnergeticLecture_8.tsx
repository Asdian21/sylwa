import { StyleLecture_8 } from "./EnergeticLecture_8.style";
...
export const Lecture_8 = () => {
  const slides = useLoadSlides("/lectures/lecture_8_slides_output");
  const [lectureText, setLectureText] = useState<string>("");

  useEffect(() => {
    const loadDocxFile = async () => {
      try {
        const response = await fetch("/word_lectures/lecture_8.docx");
