import { StyleLecture_14 } from "./EnergeticLecture_14.style";
...
export const Lecture_14 = () => {
  const slides = useLoadSlides("/lectures/lecture_14_slides_output");
  const [lectureText, setLectureText] = useState<string>("");

  useEffect(() => {
    const loadDocxFile = async () => {
      try {
        const response = await fetch("/word_lectures/lecture_14.docx");
