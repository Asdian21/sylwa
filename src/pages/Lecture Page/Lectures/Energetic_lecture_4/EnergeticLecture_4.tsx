import { StyleLecture_4 } from "./EnergeticLecture_4.style";
...
export const Lecture_4 = () => {
  const slides = useLoadSlides("/lectures/lecture_4_slides_output");
  const [lectureText, setLectureText] = useState<string>("");

  useEffect(() => {
    const loadDocxFile = async () => {
      try {
        const response = await fetch("/word_lectures/lecture_4.docx");
