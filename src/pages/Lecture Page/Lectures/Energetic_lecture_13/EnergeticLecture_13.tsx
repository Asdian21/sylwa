import { StyleLecture_13 } from "./EnergeticLecture_13.style";
...
export const Lecture_13 = () => {
  const slides = useLoadSlides("/lectures/lecture_13_slides_output");
  const [lectureText, setLectureText] = useState<string>("");

  useEffect(() => {
    const loadDocxFile = async () => {
      try {
        const response = await fetch("/word_lectures/lecture_13.docx");
