import { StyleLecture_6 } from "./EnergeticLecture_6.style";
...
export const Lecture_6 = () => {
  const slides = useLoadSlides("/lectures/lecture_6_slides_output");
  const [lectureText, setLectureText] = useState<string>("");

  useEffect(() => {
    const loadDocxFile = async () => {
      try {
        const response = await fetch("/word_lectures/lecture_6.docx");
