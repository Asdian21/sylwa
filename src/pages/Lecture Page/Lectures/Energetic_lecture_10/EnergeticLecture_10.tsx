import { StyleLecture_10 } from "./EnergeticLecture_10.style";
...
export const Lecture_10 = () => {
  const slides = useLoadSlides("/lectures/lecture_10_slides_output");
  const [lectureText, setLectureText] = useState<string>("");

  useEffect(() => {
    const loadDocxFile = async () => {
      try {
        const response = await fetch("/word_lectures/lecture_10.docx");
